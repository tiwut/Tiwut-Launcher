...
class AppStoreClient(tk.Tk):
    ...
    def _create_custom_title_bar(self):
        self.title_bar = ttk.Frame(self.root_container, style="Primary.TFrame", height=40)
        self.title_bar.pack(fill="x", side="top")

        self.title_bar.bind("<ButtonPress-1>", self.start_move)
        self.title_bar.bind("<B1-Motion>", self.do_move)

        title_label = ttk.Label(self.title_bar, text=" Tiwut App Store", style="TitleBar.TLabel", anchor="w")
        title_label.pack(side="left", padx=10)
        title_label.bind("<ButtonPress-1>", self.start_move)
        title_label.bind("<B1-Motion>", self.do_move)

        button_frame = ttk.Frame(self.title_bar, style="Primary.TFrame")
        button_frame.pack(side="right", fill='y')

        close_button = ttk.Button(button_frame, text="✕", command=self.destroy, style="WindowButton.TButton", width=4)
        close_button.pack(side="right")
        
        self.maximize_button = ttk.Button(button_frame, text="🗖", command=self.toggle_maximize, style="WindowButton.TButton", width=4)
        self.maximize_button.pack(side="right")
        
        minimize_button = ttk.Button(button_frame, text="—", command=self.iconify, style="WindowButton.TButton", width=4)
    ...
    def setup_styles(self):
        ...
        s.configure('TitleBar.TLabel', background=S["primary"], foreground=S["text"], font=S["font_body_bold"])
        ...
        s.configure("WindowButton.TButton", padding=5, font=("Segoe UI Symbol", 10), background=S["primary"], foreground=S["text"], borderwidth=0)
        s.map("WindowButton.TButton", background=[('active', S["secondary"])])
